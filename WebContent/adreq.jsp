           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          <tbody>
                                                   ...
                                                   <td>
                                                   <a href="appreq.jsp?id=<%=resultSet.getString("rid") %> bg=<%=resultSet.getString("rbgroup") %>" onclick="return confirm_alert(this);">Approved</a><br>
                                                   <a href="disappreq.jsp?id=<%=resultSet.getString("rid") %>" onclick="return confirm_alert(this);">DisApproved</a>
                                                   </td>
