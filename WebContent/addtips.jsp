...
font-size: 16px;"> &nbsp; <a href="index.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
      ...
      <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
         		<h2>&nbsp&nbspAdd Health Tips</h2><br><br>
         		 <div class="col-md-12">
          <div class="card">
        <form action="AddTips" method="post">
        
                <div class="form-group row">
                <input type="hidden" name="action" value="add"/>
    			<label for="inputEmail3" class="col-sm-3 form-control-label">Tip No. :</label>
                  <div class="col-sm-9">
                    <textarea cols="7" rows="1" class="form-control" name="tipno" placeholder="Enter Health Tip No." onkeypress="return isNumberKey(event)" minlength="4" maxlength="12" required></textarea>
                  </div>
                </div>
                
                <div class="form-group row">
                <input type="hidden" name="action" value="add"/>
    			<label for="inputEmail3" class="col-sm-3 form-control-label">Health Tip :</label>
                  <div class="col-sm-9">
                    <textarea cols="7" rows="5" class="form-control" name="bbht" placeholder="Enter Health Tips" required></textarea>
                    </div>
                </div>
                <br>
                <div class="form-group row m-b-0">
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary">Add Health Tip</button>
                  </div>
                </div>
